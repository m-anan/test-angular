      ...
      <div class="grid grid-cols-3 gap-4 pt-4 relative">
        ...
        >
          <svg
            ...
            fill="#939393"
            [ngClass]="{
              ' fill-[#DE768A]': store.value.offeringType === 'product'
            }"
          >
            <path d="M15 17.3333L20 20V9.99988H10V20L15 17.3333Z" />
            <path
            ...
            />
            <path d="M21 0V8H9V0H21Z" />
            <path d="M7 8V0H0V8H7Z" />
            <path d="M23 8H30V0H23V8Z" />
          </svg>
          <span
            class="font-bold text-xl"
            [ngClass]="{
              ' text-[#DE768A] ': store.value.offeringType === 'product'
            }"
          >
            Product</span
          >
          ...
          >
            ...
            >
              <path
                ...
                fill="#939393"
                [ngClass]="{
                  'fill-[#DE768A]': store.value.offeringType === 'service'
                }"
              />
              <defs>
                <linearGradient
            ...
            <span
              class="font-bold text-xl"
              [ngClass]="{
                ' text-[#DE768A] ': store.value.offeringType === 'service'
              }"
            >
              Service</span
            >
        ...
        >
          <svg
            ...
            fill="#939393"
            [ngClass]="{
              'fill-[#DE768A]': store.value.offeringType === 'subscription'
            }"
          >
            <path
              fill-rule="evenodd"
            ...
            />
            <path d="M31.0083 25.6824L25.1615 28.5734L24.7417 22.0643L31.0083 25.6824Z" />
            <path d="M1.99158 7.31763L7.83846 4.42664L8.25825 10.9357L1.99158 7.31763Z" />
            <path
              fill-rule="evenodd"
              clip-rule="evenodd"
          ...
          <span
            [ngClass]="{
              ' text-[#DE768A] ': store.value.offeringType === 'subscription'
            }"
            class="font-bold text-xl"
            >Subscription</span
          >
